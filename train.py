...
def main():
    ...
    data_cfgs = load_config('/home/findev/dev/project/pl_YOLO/configs/data/coco2017.yaml')
    data = build_data(data_cfgs['datamodule'])
    data = data(data_cfgs)

    model_cfgs = load_config('/home/findev/dev/project/pl_YOLO/configs/model/yolov7/yolov7.yaml')
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        monitor='total_loss',
        mode="max",
        filename='{epoch:02d}-{total_loss:.3f}',
    )
